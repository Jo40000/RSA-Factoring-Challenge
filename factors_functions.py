...
def unix_time(funtion):
    '''Return 'real', 'sys' and 'user' elapsed time, like UNIX's command 'time'
    you can calculate the amount of used CPU-time used by your function/callable by summing 'user' and 'sys'. 'real' is just like the wall clock.
    '''
